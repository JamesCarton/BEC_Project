...
public class MyTagCampaignGridAdapter extends RecyclerView.Adapter<MyTagCampaignGridAdapter.CustomViewHolder> {

    List<CampaignModel.Root> campaignModelRoot;
    Context context;


    public MyTagCampaignGridAdapter(Context context, List<CampaignModel.Root> campaignModelRoot) {
    ...
    public CustomViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_mytagcampaign_grid, parent, false);
